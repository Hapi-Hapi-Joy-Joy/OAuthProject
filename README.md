...
Clone this repo, and then ```npm install```. There are two separate branches **Twitwork** and **Twit-Edit** that we created alongside our main project in an attempt to get it all working - PLEASE DO NOT MERGE THEM. They will crash and break everything and we will be very sad. 
